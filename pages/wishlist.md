- bugs and basic borked functionality
	...
	- other (sorted by annoyance level):
		...
		- timestamp support for local audio and video files, not just youtube. we're a "local first" app after all
		  id:: 676f3c79-aa49-41ee-8edf-67e7bbaa7afd
		  collapsed:: true
			- [another sethyuan moment](https://web.archive.org/web/20240826181136/https://github.com/sethyuan/logseq-plugin-media-ts/blob/master/README.en.md)
